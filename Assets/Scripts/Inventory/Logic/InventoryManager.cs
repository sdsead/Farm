    ...
    public class InventoryManager : Singleton<InventoryManager>,ISaveable
    {
        ...
        private void AddItemAtIndex(int ID, int index, int amount)
        {
            ...
            else
            {
                ...
                {
                    itemAmount = currentAmount,itemID = ID
                };
        ...
        /// </summary>
        /// <param name="ID"></param>
        /// <param name="Removemount"></param>
        public void RemoveItem(int ID, int Removemount)
        {
            var index = GetItemIndexInBag(ID);

            if (playerBag.itemList[index].itemAmount > Removemount)
            {
                var amount = playerBag.itemList[index].itemAmount - Removemount;
                var item = new InventoryItem { itemID = ID, itemAmount = amount };

                playerBag.itemList[index] = item;
            }else if (playerBag.itemList[index].itemAmount == Removemount)
            {
                var item = new InventoryItem();
                playerBag.itemList[index] = item;
            }
