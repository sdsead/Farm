...
public class NPCMovement : MonoBehaviour, ISaveable
{
    ...
    private void OnAfterSceneLoadedEvent()
    {
        ...
        if (!isFirstLoad)
        {
            ...
            var schedule = new ScheduleDetails(0, 0, 0, 0, currentSeason, targetScene, 
                (Vector2Int)tragetGridPosition, stopAnimationClip, interactable);
    ...
    public void RestoreData(GameSaveData saveData)
    {
        ...
        Vector3 pos = saveData.characterPosDict["currentPosition"].GetVector3();
        Vector3Int gridPos = (Vector3Int)saveData.characterPosDict["targetGridPosition"].GetVector2Int();
